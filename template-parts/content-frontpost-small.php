...
<article <?php post_class(); ?> itemscope itemtype="http://schema.org/NewsArticle">
	...
	<?php } elseif ( ! post_password_required() && $imagesrc != '') {  ?>
		<div class="entry-thumbnail fadein" aria-hidden="true" role="presentation" tabindex="-1"><a href="<?php the_permalink(); ?>"><span class="thumb-wrap"><img src="<?php echo esc_url( $imagesrc ); ?>" alt="<?php echo esc_attr( get_the_title() ); ?>"></span></a></div><!-- end .entry-thumbnail -->
	<?php } ?>
